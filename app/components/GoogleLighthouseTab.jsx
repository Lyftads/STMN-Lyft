  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div className="glass-card-static" style={{ padding: 22, display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
        <span style={{ width: 42, height: 42, borderRadius: 11, background: 'rgba(251,191,36,0.14)', color: '#fbbf24', display: 'grid', placeItems: 'center', fontSize: 20, fontWeight: 800 }}><Icon name="warning" size={14} /></span>
        <div style={{ flex: 1, minWidth: 200 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{ fontSize: 9.5, color: '#fbbf24', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase' }}>Lighthouse</div>
            <PlatformBadges sources={['google']} size={14} />
          </div>
          <div style={{ fontSize: 18, fontWeight: 900, color: '#fff', marginTop: 4, letterSpacing: '-0.02em' }}>
            Alert center Google Ads · {summary.total} anomalie ({data?.baseline_window || 14}gg baseline)
          </div>
        </div>
