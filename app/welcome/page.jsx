...
const I18N = {
  ...
  fr: {
    ...
    features: [
      ...
      { icon: '⤳', title: 'User Path', desc: 'Parcours utilisateur page à page (Sankey) reconstruit depuis GA4 — voyez comment ils naviguent et où ils décrochent.' },
  ...
  de: {
    ...
    features: [
      ...
      { icon: '⤳', title: 'User Path', desc: 'Nutzerreise Seite für Seite (Sankey) aus GA4 rekonstruiert — sehen Sie, wie navigiert wird und wo abgesprungen wird.' },
