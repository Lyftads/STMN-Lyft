...
const IT = {
  ...
  status: {
    eyebrow: 'Dove siamo', title: 'Prodotto live, tutti i gate di piattaforma superati',
    done: ['Piattaforma completa live su lyftai.io (web + mobile)', 'Landing con demo interattiva (software reale, dati finti)', 'Beta tenant DTC attivo (dogfooding quotidiano) + primo cliente pagante in onboarding', 'Billing attivo: Stripe + Shopify Managed Pricing', 'Meta Marketing API Advanced Access — APPROVATA (lug 2026)', 'App pubblicata sullo Shopify App Store', 'Google Ads API Basic Access — attivo'],
    pending: [],
...
const EN = {
  ...
  status: {
    eyebrow: 'Where we are', title: 'Product live, every platform gate cleared',
    done: ['Full platform live on lyftai.io (web + mobile)', 'Landing with interactive demo (real software, mock data)', 'Active DTC beta tenant (daily dogfooding) + first paying customer onboarding', 'Billing live: Stripe + Shopify Managed Pricing', 'Meta Marketing API Advanced Access — APPROVED (Jul 2026)', 'App published on the Shopify App Store', 'Google Ads API Basic Access — active'],
    pending: [],
