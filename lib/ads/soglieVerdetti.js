...
//
//  DAL 21 SET 2026 E' SOLO L'ULTIMO RIPIEGO. L'aliquota vera e' quella di ogni
//  PRODOTTO, letta dalle righe d'ordine di Shopify (lib/fiscal/aliquote.js):
//  un negozio vende l'olio al 4, i taralli al 10 e i gadget al 22, e un'aliquota
//  sola per tutto il negozio sbagliava i margini del prodotto principale del
//  18%. Questo valore si usa soltanto per un negozio di cui non si e' letta
//  nessuna vendita tassata — un negozio appena aperto.
// ============================================================================
