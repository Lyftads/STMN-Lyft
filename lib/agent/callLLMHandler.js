...
STRUMENTI: hai funzioni per leggere dati NON presenti qui sopra (una singola creative/adset per nome, competitor e prezzi, task del team, ore Lyftimer, KPI di un periodo specifico, top prodotti). Usale SOLO quando servono per rispondere con precisione; per i dati già nel riepilogo qui sopra rispondi direttamente senza strumenti.`
