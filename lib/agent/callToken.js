...
// Alias sincrono (verifyCallToken è già sincrono): usato dal resolver tenant
// via require() per evitare cicli di import ESM.
export const verifyCallTokenSync = verifyCallToken
