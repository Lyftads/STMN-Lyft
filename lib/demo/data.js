...
// Corrispettivi: registro fiscale d'esempio, coerente col fatturato della demo (vuoto fino al 21 set).
import { demoCorrispettivi, CORRISPETTIVI_PATHS } from './corrispettivi.js'
...
export function demoData(path, search, method = 'GET') {
  ...
  if (CORRISPETTIVI_PATHS.has(p)) { const r = demoCorrispettivi(p, search, method, { DEMO_PRODUCTS, ymd, iso, DAY, metrics: demoMetrics }); if (r !== undefined) return r }
