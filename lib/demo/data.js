...
function demoPriceComparison() {
  const cats = [
    { id: 'grips', label: 'Paracalli', ownAvg: 24.9 },
    { id: 'ropes', label: 'Corde', ownAvg: 31.5 },
    { id: 'men_apparel', label: 'Abb. Uomo', ownAvg: 38.0 },
    { id: 'women_apparel', label: 'Abb. Donna', ownAvg: 36.0 },
  ]
