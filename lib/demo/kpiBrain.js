...
// Il genere esce come CODICE, come dalla route vera (/api/kpi-province @13): lo traduce la pagina.
...
function demoProvince(search, C) {
  ...
  return {
    ok: true,
    range: P.range,
    mercato: { italia: true, fonte: 'ordini', paese: 'Italy', quotaItalia: quota(it.orders, tuttiOrdini) },
    regioni,
    spesaRegioni: {
