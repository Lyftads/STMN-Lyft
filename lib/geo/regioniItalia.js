...
const REGIONI = {
  ...
  // Gallura Nord-Est Sardegna e Sulcis Iglesiente: le province della riforma sarda del 2025, come le
  // scrive Shopify (Saracino, 21 set 2026: 32 ordini restavano fuori da ogni regione).
  'Sardegna': ['Cagliari', 'Nuoro', 'Oristano', 'Sassari', 'Sud Sardegna', 'Carbonia-Iglesias', 'Medio Campidano', 'Ogliastra', 'Olbia-Tempio', 'Gallura Nord-Est Sardegna', 'Sulcis Iglesiente'],
