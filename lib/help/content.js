...
export const HELP_ARTICLES = [
  ...
  A({ id: 'timeTracking', tab: 'timeTracking', icon: 'clock', group: 'Productivity AI', category: 'features',
    title: 'Lyftimer', summary: 'Un time-tracker in stile Hubstaff con timer live, timesheet e totali per persona e per progetto.',
    sections: [
  ...
  A({ id: 'creative', tab: 'creative', icon: 'image', group: 'Meta', category: 'features',
    title: 'Creative (Meta)', summary: 'La libreria delle creatività Meta attive, ciascuna con le proprie performance.',
    sections: [
      { h: 'Cos\'è', p: 'La tab Creative ti mostra tutte le creatività attive sul tuo account Meta affiancate ai loro KPI. Invece di chiederti "quale immagine sta funzionando?", lo vedi a colpo d\'occhio: CTR, ROAS e spesa per ogni asset. È il punto da cui capisci quali contenuti reggono il peso delle campagne e quali stanno trascinando i risultati verso il basso.' },
      { h: 'Cosa include', list: [
        'Le anteprime delle creatività con le metriche chiave (CTR, ROAS, spesa) accanto a ciascuna.',
        'L\'ordinamento per performance, per portare in cima le migliori o smascherare le peggiori.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Incrocia questa vista con Creative Fatigue per capire non solo cosa rende poco, ma cosa sta rendendo sempre meno perché si è "bruciato".',
        'Non scalare mai una sola creatività vincente: confrontane diverse e cerca il pattern comune, perché è quello che potrai replicare.',
      ] },
    ] }),
  A({ id: 'metaDetail', tab: 'metaDetail', icon: 'list', group: 'Meta', category: 'features',
    title: 'Meta Detail', summary: 'Il dettaglio delle campagne Meta con tutti i KPI e il drill-down per segmento di pubblico.',
    sections: [
      { h: 'Cos\'è', p: 'Meta Detail è la vista a campagne del tuo account Meta: la tabella completa con tutti i KPI, più la possibilità di aprire il dettaglio per segmento di pubblico (Nuovo, Esistenti, Interagito, Sconosciuto). È lo strumento per capire non solo quanto rende una campagna, ma a chi sta rendendo, che è spesso l\'informazione che cambia le decisioni.' },
      { h: 'Cosa include', list: [
        'Una tabella campagne con i KPI completi, ordinabile e filtrabile per stato.',
        'Il drill-down per segmento di pubblico, che apre i numeri della campagna divisi per tipo di audience.',
      ] },
      { h: 'Come funziona', list: [
        'Il drill per segmenti effettua la chiamata API solo quando attivi esplicitamente il toggle: è una scelta voluta per non consumare richieste (e non rischiare i limiti orari di Meta) finché non ti servono davvero quei dati.',
        'Come tutto il modulo Meta, segue il time frame selezionato in alto.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Apri il drill segmenti solo sulle campagne che ti interessano davvero, per restare leggero sulle richieste API.',
        'Guarda il segmento "Nuovo": è lì che si misura la vera capacità di una campagna di portarti clienti freschi, non solo di rivendere a chi già ti conosce.',
      ] },
    ] }),
  A({ id: 'metaKpi', tab: 'metaKpi', icon: 'gauge', group: 'Meta', category: 'features',
    title: 'Meta KPI', summary: 'I KPI medi dell\'account Meta, anche divisi per segmento di pubblico, con card e grafici che si adattano.',
    sections: [
      { h: 'Cos\'è', p: 'Meta KPI è la vista d\'insieme delle performance Meta a livello di account, con una marcia in più: delle tab per segmento di pubblico. Selezionando un segmento, tutte le card e i grafici si riadattano per mostrarti come si comporta quel pubblico specifico. È il modo per capire dove l\'account funziona e dove no, senza perderti nel dettaglio delle singole campagne.' },
      { h: 'Cosa include', list: [
        'Le metriche fondamentali: CAC, CPO, costo per acquisto, acquisti, ROAS, CPC, CTR, CPM e frequenza.',
        'Le tab per segmento — Tutti, Nuovo, Esistenti, Interagito, Sconosciuto — che ridisegnano l\'intera schermata sul pubblico scelto.',
        'Grafici e variazioni legati al time frame, per leggere l\'andamento e non solo lo scatto del momento.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Confronta il CAC dei diversi segmenti: spostare l\'attenzione e il budget verso il pubblico che ti porta clienti nuovi al costo più basso è una delle leve più rapide sul rendimento.',
        'Tieni d\'occhio la frequenza: quando sale troppo è il segnale che stai saturando il pubblico e serve aria fresca (creatività o audience).',
      ] },
    ] }),
  A({ id: 'lighthouse', tab: 'lighthouse', icon: 'warning', group: 'Meta', category: 'advanced',
    title: 'Lighthouse (Meta)', summary: 'Alert e diagnosi azionabili sulle campagne Meta, con la spiegazione di cosa correggere.',
    sections: [
      { h: 'Cos\'è', p: 'Lighthouse è il sistema di allerta del tuo account Meta: invece di costringerti a scovare i problemi scorrendo tabelle, te li porta in superficie già pronti, con una spiegazione di cosa non va e di come intervenire. È pensato per farti agire in fretta sui problemi che costano di più.' },
      { h: 'Cosa include', list: [
        'Alert prioritari, ognuno con una descrizione chiara del problema.',
        'Indicazioni concrete su come intervenire, non solo la segnalazione fine a sé stessa.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Affronta gli alert in ordine di priorità: sono ordinati per impatto, quindi i primi sono quelli che ti fanno risparmiare o guadagnare di più.',
      ] },
    ] }),
  A({ id: 'creativeFatigue', tab: 'creativeFatigue', icon: 'pulse', group: 'Meta', category: 'advanced',
    title: 'Creative Fatigue', summary: 'Capisci quando una creatività si è "bruciata" e va sostituita, prima che peggiori i risultati.',
    sections: [
      { h: 'Cos\'è', p: 'Ogni creatività ha una vita: all\'inizio rende, poi il pubblico la vede troppe volte, smette di reagire e le performance scendono. Creative Fatigue rileva questo affaticamento — frequenza che sale, CTR che scende — e te lo segnala in tempo, così sostituisci la creatività prima che trascini giù l\'intera campagna invece di accorgertene a danno fatto.' },
      { h: 'Cosa include', list: [
        'Indicatori di fatica per ogni creatività, che traducono i segnali tecnici in un giudizio leggibile.',
        'L\'andamento del calo di performance nel tempo, per distinguere un brutto giorno da un declino vero.',
      ] },
      { h: 'Consigli e best practice', list: [
        'La combinazione classica da tenere d\'occhio è frequenza in salita e CTR in discesa: quando le vedi insieme, è il momento di rinnovare.',
        'Tieni sempre due o tre creatività fresche pronte in canna, così la sostituzione non ti coglie impreparato e non lasci buchi nelle campagne.',
      ] },
    ] }),
  A({ id: 'budgetAdvisor', tab: 'budgetAdvisor', icon: 'wallet', group: 'Meta', category: 'advanced',
    title: 'Budget Advisor (Meta)', summary: 'Suggerimenti su come ridistribuire il budget tra le campagne Meta per massimizzare il ritorno.',
    sections: [
      { h: 'Cos\'è', p: 'Budget Advisor guarda le performance delle tue campagne Meta e ti dice dove conviene spostare i soldi: quali campagne meritano più budget perché stanno rendendo e quali andrebbero ridimensionate. È l\'aiuto per prendere le decisioni di allocazione che fanno la differenza tra spendere e investire.' },
      { h: 'Cosa include', list: [
        'Raccomandazioni di allocazione del budget tra le campagne.',
        'Indicazioni concrete di scale up o scale down per ciascuna.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Muovi il budget in modo graduale: aumenti troppo bruschi possono mandare le campagne in fase di apprendimento e peggiorare temporaneamente i risultati.',
      ] },
    ] }),

  // ── GOOGLE ────────────────────────────────────────────────────────────
  A({ id: 'googleDetail', tab: 'googleDetail', icon: 'list', group: 'Google', category: 'features',
    title: 'Google Detail', summary: 'Il dettaglio delle campagne Google Ads con tutti i KPI per il periodo scelto.',
    sections: [
      { h: 'Cos\'è', p: 'Google Detail è la vista a campagne del tuo account Google Ads: la tabella completa con spesa, conversioni, valore e ROAS per ogni campagna, nel periodo che selezioni. È il gemello di Meta Detail per il mondo Google, e serve a capire quali campagne search, shopping o Performance Max stanno tirando.' },
      { h: 'Cosa include', list: [
        'Una tabella campagne con spesa, conversioni, valore generato e ROAS.',
        'La segmentazione per data, per leggere l\'andamento nel tempo.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Confronta sempre il ROAS con il margine reale dei prodotti spinti: una campagna con ROAS alto su prodotti a basso margine può rendere meno di una con ROAS più modesto su prodotti redditizi.',
      ] },
    ] }),
  A({ id: 'googleProducts', tab: 'googleProducts', icon: 'bag', group: 'Google', category: 'features',
    title: 'Prodotti (Google)', summary: 'Le performance dei singoli prodotti nelle campagne Shopping e Performance Max.',
    sections: [
      { h: 'Cos\'è', p: 'Questa tab scende al livello del prodotto nelle campagne Google: ti mostra quali articoli del feed Shopping/PMax stanno spendendo budget e quali stanno convertendo. È fondamentale perché in Shopping spesso pochi prodotti si mangiano gran parte della spesa, e non sempre sono quelli che rendono.' },
      { h: 'Cosa include', list: [
        'Spesa e ritorno per ogni prodotto del feed.',
        'L\'evidenza dei prodotti che spingono i risultati e di quelli che sprecano budget.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Individua i prodotti che assorbono spesa senza convertire ed escludili o riducili: è uno dei modi più rapidi per migliorare il ROAS complessivo di Shopping.',
      ] },
    ] }),
  A({ id: 'googleKpi', tab: 'googleKpi', icon: 'gauge', group: 'Google', category: 'features',
    title: 'Google KPI', summary: 'I KPI medi dell\'account Google Ads, legati al time frame selezionato.',
    sections: [
      { h: 'Cos\'è', p: 'Google KPI ti dà la vista d\'insieme delle performance del tuo account Google Ads: spesa, conversioni, valore, ROAS, CPC e CTR aggregati. È il posto da cui capisci in fretta lo stato di salute di Google prima di entrare nel dettaglio delle campagne o dei prodotti.' },
      { h: 'Come funziona', list: [
        'Il ROAS è calcolato come valore delle conversioni diviso la spesa: è il rapporto che ti dice quanti euro generi per ogni euro investito.',
        'Tutti i numeri seguono il time frame selezionato, così puoi confrontare periodi diversi cambiando solo il selettore in alto.',
      ] },
      { h: 'Consigli e best practice', list: [
  ...
  A({ id: 'googleLighthouse', tab: 'googleLighthouse', icon: 'warning', group: 'Google', category: 'advanced',
    title: 'Lighthouse (Google)', summary: 'Alert e diagnosi azionabili sulle campagne Google Ads.',
    sections: [
      { h: 'Cos\'è', p: 'Lighthouse per Google segnala criticità e opportunità nelle tue campagne Ads con spiegazioni su cosa migliorare. È il sistema di allerta che ti porta i problemi in superficie invece di farteli cercare, così intervieni prima che incidano sui risultati.' },
      { h: 'Cosa include', list: [
        'Alert prioritari, ognuno con una descrizione azionabile di cosa fare.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Tratta gli alert come una checklist settimanale: risolverli con costanza tiene l\'account in salute meglio di grandi interventi sporadici.',
      ] },
    ] }),
  A({ id: 'googleBudgetAdvisor', tab: 'googleBudgetAdvisor', icon: 'wallet', group: 'Google', category: 'advanced',
    title: 'Budget Advisor (Google)', summary: 'Suggerimenti su come ridistribuire il budget tra le campagne Google.',
    sections: [
      { h: 'Cos\'è', p: 'Budget Advisor per Google ti indica come spostare il budget tra le campagne in base alle performance, così metti più soldi dove rendono e meno dove non rendono. È l\'aiuto per allocare il budget con metodo invece che a intuito.' },
      { h: 'Cosa include', list: [
        'Raccomandazioni di budget per ciascuna campagna.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Procedi per piccoli aggiustamenti e dai tempo alle campagne di assestarsi prima di valutare l\'effetto di un cambio di budget.',
      ] },
    ] }),
