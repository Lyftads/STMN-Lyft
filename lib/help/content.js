...
export const HELP_ARTICLES = [
  ...
  A({ id: 'cassa', tab: 'cassa', icon: 'euro', group: 'Commerce', category: 'features',
    title: 'Cassa', summary: 'La liquidità reale dei tuoi conti bancari accanto alle performance: sai cosa rende E cosa puoi permetterti.',
    sections: [
      { h: 'Cos\'è e perché completa il quadro', p: 'Le altre tab ti dicono cosa sta rendendo (ads, prodotti, clienti). La Cassa aggiunge l\'altra metà della decisione: quanta liquidità hai davvero. Collegando i conti aziendali con una connessione bancaria europea di SOLA LETTURA (PSD2), LyftAI vede saldi e movimenti reali e li mette accanto alle performance. Da quel momento anche il Cervello ne tiene conto: se gli chiedi "posso alzare il budget Meta di 2.000€?", la risposta considera la cassa reale, non solo il ROAS.' },
      { h: 'Cosa mostra', list: [
        'Il saldo totale e per conto, aggiornato più volte al giorno.',
        'Entrate e uscite degli ultimi 90 giorni, mese per mese.',
        'Le uscite classificate automaticamente per categoria dall\'AI (fornitori, stipendi, tasse, marketing, logistica…).',
        'La proiezione di cassa a 30/60/90 giorni, stimata sulle medie storiche dei tuoi movimenti.',
      ] },
      { h: 'Come si collega', list: [
        'Premi "Collega banca", cerca la tua banca e autorizza l\'accesso in sola lettura sul sito della banca stessa: LyftAI non vede mai le tue credenziali.',
        'La connessione è regolata dalla normativa europea PSD2, dura fino a 180 giorni e puoi revocarla in ogni momento (da qui o dalla tua banca).',
        'Puoi collegare più banche e più conti: i numeri si sommano nel quadro totale.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Leggi la proiezione come una stima direzionale, non una certezza: si basa sulle medie dei movimenti recenti e non conosce le spese straordinarie in arrivo.',
        'Prima di scalare un budget pubblicitario, chiedi al Cervello se è sostenibile: incrocerà ROAS e proiezione di cassa e ti dirà quanto margine hai davvero.',
        'Se la banca risulta "in collegamento", dai qualche secondo e premi Aggiorna: la prima sincronizzazione può richiedere un momento.',
      ] },
    ] }),
