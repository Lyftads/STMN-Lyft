...
export const HELP_ARTICLES = [
  ...
  A({ id: 'calendar', tab: 'calendar', icon: 'calendar', group: 'Productivity AI', category: 'features',
    title: 'Calendario', summary: 'Ferie, permessi, promo e eventi del team in una vista sola: chi c\'è, chi manca e cosa parte quando.',
    sections: [
      { h: 'Cos\'è', p: 'Il Calendario mette sulla stessa griglia due cose che di solito vivono in file separati: le assenze delle persone (ferie, permessi, malattia) e le iniziative commerciali (promo sul sito, promo nei negozi, eventi, riunioni). Serve a rispondere a una domanda che nessun foglio Excel risolve bene: quando lancio questa promo, chi c\'è per seguirla?' },
      { h: 'Cosa include', list: [
        'Tre viste: mese per la visione d\'insieme, settimana per il dettaglio, agenda per l\'elenco in ordine di data.',
        'Filtri per tipo con il conteggio delle voci, ricerca per persona o titolo, e un filtro "solo io".',
        'Le voci "da valutare": una promo ipotizzata resta spenta di default e non sporca la pianificazione finché non la confermi.',
      ] },
      { h: 'Come si inserisce una voce', list: [
        'Con il pulsante in alto a destra, oppure con un doppio clic sul giorno che ti interessa nella griglia.',
        'Le assenze finiscono nello stesso registro di ferie e permessi del team: se le inserisce un amministratore sono già approvate, altrimenti restano in attesa.',
        'Le promo e gli eventi vogliono un titolo e un intervallo di date; la nota è facoltativa e serve ai dettagli operativi.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Inserisci le promo appena sono anche solo ipotesi, marcandole "da valutare": vederle sul calendario è il modo più rapido per accorgersi di due iniziative sovrapposte.',
        'Guarda le assenze prima di fissare la data di un lancio: una promo che parte mentre chi la segue è in ferie parte da sola.',
        'Le note delle assenze restano visibili solo all\'interessato e agli amministratori: il calendario dice chi manca, non perché.',
      ] },
    ] }),
  A({ id: 'timeOff', tab: 'timeOff', icon: 'clock', group: 'Productivity AI', category: 'features',
    title: 'Ferie e permessi', summary: 'Le richieste di assenza del team con approvazione e conteggio dei giorni consumati.',
    sections: [
      { h: 'Cos\'è', p: 'La sezione dove si chiedono e si approvano ferie, permessi e malattia. È la stessa fonte che alimenta il Calendario: qui si gestiscono le richieste una per una, lì si vedono insieme a promo ed eventi per capire chi c\'è quando.' },
      { h: 'Cosa mostra', list: [
        'I giorni già consumati nell\'anno per tipo, contati in giorni LAVORATIVI: sabati e domeniche non pesano.',
        'Il numero di richieste in attesa: per un amministratore sono quelle da approvare, per un membro le proprie.',
        'L\'elenco filtrabile per anno, stato e persona, con approvazione o rifiuto in linea.',
      ] },
      { h: 'Come funziona l\'approvazione', list: [
        'Se la richiesta la inserisce un amministratore è già approvata; se la inserisce un membro resta in attesa.',
        'Solo le richieste APPROVATE contano nei totali: quelle in attesa restano separate, così un numero provvisorio non viene scambiato per definitivo.',
        'Un membro può cancellare le proprie richieste; un amministratore quelle di chiunque.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Approva o rifiuta in giornata: una richiesta ferma blocca la pianificazione di chi deve coprire il turno.',
        'Prima di confermare un\'assenza lunga, apri il Calendario e controlla che non cada su una promo in partenza.',
      ] },
    ] }),
  ...
  A({ id: 'metaLeadgen', tab: 'metaLeadgen', icon: 'users', group: 'Meta', category: 'features',
    title: 'Lead Gen', summary: 'L\'economia delle campagne lead: dal CPL al profitto reale, con CAC, ROI e CPL di pareggio per ogni campagna.',
    sections: [
      { h: 'Cos\'è e che problema risolve', p: 'Le campagne di lead generation si giudicano quasi sempre solo sul costo per lead, ma il CPL da solo non dice se stai guadagnando: un CPL di 15€ è ottimo se un cliente chiuso ti vale 800€, pessimo se te ne vale 60€. Questa tab aggiunge l\'economia che manca: imposti quanto vale mediamente un cliente chiuso, quanti lead diventano clienti e il tuo margine, e ogni campagna viene rivalutata in termini di CAC, ricavo, profitto e ROI. Nessun dato personale dei lead viene letto o salvato: si usano solo i numeri aggregati delle campagne.' },
      { h: 'Cosa mostra', list: [
        'Lead, spesa e CPL del periodo per ogni campagna lead di Meta, con confronto sul periodo precedente.',
        'Il CPL di pareggio: la soglia sotto cui una campagna genera profitto, calcolata come valore × margine × tasso di chiusura. Ogni campagna ha il badge "in profitto" o "sopra pareggio".',
        'CAC stimato (spesa / clienti stimati), ricavo, profitto e ROI di ogni campagna e del totale.',
        'L\'andamento giornaliero di lead e CPL, con la linea del pareggio sul grafico del CPL.',
      ] },
      { h: 'Come impostare i parametri', list: [
        'Valore medio cliente: quanto ti vale mediamente un lead che diventa cliente (scontrino medio del servizio, o LTV se lo conosci).',
        'Chiusura lead → cliente: la percentuale di lead che diventano clienti paganti. Se non la conosci, parti da una stima prudente e affinala col tempo.',
        'Margine: quanto del valore resta dopo i costi di erogazione. Per i servizi puri spesso è vicino al 100%.',
        'Se le campagne vendono cose diverse (es. un servizio da 300€ e uno da 2.000€), usa gli override per campagna nella tabella: valore e chiusura specifici, il resto eredita i parametri del workspace.',
      ] },
      { h: 'Consigli e best practice', list: [
        'Decidi i budget sul profitto e sul CAC, non sul CPL: una campagna con CPL più alto ma lead che chiudono meglio spesso è quella da scalare.',
        'Usa il CPL di pareggio come soglia operativa nelle aste: finché resti sotto, ogni lead in più è margine.',
        'Rivedi tasso di chiusura e valore ogni mese con i dati veri del tuo CRM o gestionale: più i parametri sono onesti, più profitto e ROI sono affidabili.',
      ] },
    ] }),
