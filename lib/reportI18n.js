...
const D = {
  ...
  // Voci dei report del menu Report (le stesse della tabella dell'app)
  'Fatturato Koongo': { en: 'Koongo revenue', es: 'Ingresos Koongo', fr: 'Chiffre d’affaires Koongo', de: 'Koongo-Umsatz' },
  'Fatturato totale': { en: 'Total revenue', es: 'Ingresos totales', fr: 'Chiffre d’affaires total', de: 'Gesamtumsatz' },
  'Fatt. NC': { en: 'Rev. new', es: 'Ingr. nuevos', fr: 'CA nouveaux', de: 'Umsatz Neukunden' },
  'Fatt. RC': { en: 'Rev. returning', es: 'Ingr. recurrentes', fr: 'CA récurrents', de: 'Umsatz Bestandskunden' },
  'Nuovi Clienti': { en: 'New customers', es: 'Clientes nuevos', fr: 'Nouveaux clients', de: 'Neukunden' },
  'Clienti Ritorno': { en: 'Returning customers', es: 'Clientes recurrentes', fr: 'Clients récurrents', de: 'Bestandskunden' },
  'di cui Meta': { en: 'of which Meta', es: 'de los cuales Meta', fr: 'dont Meta', de: 'davon Meta' },
  'di cui Google': { en: 'of which Google', es: 'de los cuales Google', fr: 'dont Google', de: 'davon Google' },
  'Ratio LTV:CAC': { en: 'LTV:CAC ratio', es: 'Ratio LTV:CAC', fr: 'Ratio LTV:CAC', de: 'LTV:CAC-Verhältnis' },
  'AOV NC': { en: 'AOV new', es: 'AOV nuevos', fr: 'AOV nouveaux', de: 'AOV Neukunden' },
  'AOV RC': { en: 'AOV returning', es: 'AOV recurrentes', fr: 'AOV récurrents', de: 'AOV Bestandskunden' },
  'Ret%': { en: 'Ret%', es: 'Ret%', fr: 'Ret%', de: 'Ret%' },
