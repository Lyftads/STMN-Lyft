...
const D = {
  ...
  'Email inviate nel periodo': { en: 'Emails sent in the period', es: 'Emails enviados en el periodo', fr: 'Emails envoyés sur la période', de: 'Im Zeitraum gesendete E-Mails' },
  'Destinatari': { en: 'Recipients', es: 'Destinatarios', fr: 'Destinataires', de: 'Empfänger' },
  'Giorno': { en: 'Day', es: 'Día', fr: 'Jour', de: 'Tag' },
  'spesa': { en: 'spend', es: 'gasto', fr: 'dépense', de: 'Ausgaben' },
  'ricavo': { en: 'revenue', es: 'ingresos', fr: 'revenu', de: 'Umsatz' },
  'acquisti': { en: 'purchases', es: 'compras', fr: 'achats', de: 'Käufe' },
  'Lunedì': { en: 'Monday', es: 'Lunes', fr: 'Lundi', de: 'Montag' },
  'Martedì': { en: 'Tuesday', es: 'Martes', fr: 'Mardi', de: 'Dienstag' },
  'Mercoledì': { en: 'Wednesday', es: 'Miércoles', fr: 'Mercredi', de: 'Mittwoch' },
  'Giovedì': { en: 'Thursday', es: 'Jueves', fr: 'Jeudi', de: 'Donnerstag' },
  'Venerdì': { en: 'Friday', es: 'Viernes', fr: 'Vendredi', de: 'Freitag' },
  'Sabato': { en: 'Saturday', es: 'Sábado', fr: 'Samedi', de: 'Samstag' },
  'Domenica': { en: 'Sunday', es: 'Domingo', fr: 'Dimanche', de: 'Sonntag' },
  '🏆 Top 10 prodotti per fatturato': { en: '🏆 Top 10 products by revenue', es: '🏆 Top 10 productos por ingresos', fr: '🏆 Top 10 des produits par chiffre d’affaires', de: '🏆 Top 10 Produkte nach Umsatz' },
  '📅 Vendite per giorno della settimana': { en: '📅 Sales by day of week', es: '📅 Ventas por día de la semana', fr: '📅 Ventes par jour de la semaine', de: '📅 Verkäufe nach Wochentag' },
  '🌍 Vendite e ordini per paese': { en: '🌍 Sales and orders by country', es: '🌍 Ventas y pedidos por país', fr: '🌍 Ventes et commandes par pays', de: '🌍 Verkäufe und Bestellungen nach Land' },
  '🎨 Top 10 creatività Meta': { en: '🎨 Top 10 Meta creatives', es: '🎨 Top 10 creatividades Meta', fr: '🎨 Top 10 des créations Meta', de: '🎨 Top 10 Meta-Creatives' },
  'CRO — funnel di conversione': { en: 'CRO — conversion funnel', es: 'CRO — embudo de conversión', fr: 'CRO — entonnoir de conversion', de: 'CRO — Conversion-Funnel' },
  'Ritornanti': { en: 'Returning', es: 'Recurrentes', fr: 'Fidèles', de: 'Wiederkehrend' },
  'Step': { en: 'Step', es: 'Paso', fr: 'Étape', de: 'Schritt' },
  'su sessioni': { en: 'of sessions', es: 'de sesiones', fr: 'des sessions', de: 'der Sitzungen' },
  'Aggiunte al carrello': { en: 'Add to cart', es: 'Añadir al carrito', fr: 'Ajouts au panier', de: 'In den Warenkorb' },
  'Checkout': { en: 'Checkout', es: 'Checkout', fr: 'Checkout', de: 'Checkout' },
  'Add-to-cart rate': { en: 'Add-to-cart rate', es: 'Tasa de añadir al carrito', fr: 'Taux d’ajout au panier', de: 'Add-to-Cart-Rate' },
  'Checkout rate': { en: 'Checkout rate', es: 'Tasa de checkout', fr: 'Taux de checkout', de: 'Checkout-Rate' },
