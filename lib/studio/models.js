...
// ── Magnific-style: Upscaler creativo + Relight ─────────────────────────────
// Upscaler creativo (à la Magnific): alza risoluzione e RIGENERA micro-dettaglio
...
// Relight (à la Magnific Relight): cambia l'illuminazione mantenendo il soggetto.
...
// Enhance/Restore (à la Krea Enhance): nitidezza, ripristino sfocato, texture
// pelle/tessuti — senza cambiare composizione. Usa Clarity con creatività mirata.
export const ENHANCE_CREDITS = 5

// ── Model Training LoRA (à la Krea / Kive Characters) ───────────────────────
...
// ── Weave-style: Inpainting con maschera + Camera angle + Recipes ────────────
// Inpainting (à la Figma Weave): rigenera SOLO l'area dipinta dalla maschera.
...
// Recipes (à la Weave workflow): incatena operazioni 1-click su un'immagine.
