...
export const IMAGE_MODELS = [
  { id: 'flux-kontext', name: 'Prodotto fedele (Kontext)', provider: 'fal-kontext', falModel: 'fal-ai/flux-pro/kontext/max', credits: 3, badge: 'Fedeltà prodotto', envKey: 'FAL_KEY', needsRef: true },
