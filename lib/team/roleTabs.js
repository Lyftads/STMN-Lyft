...
export const ALL_TABS = [
  ...
  'tasks', 'timeTracking', 'chat', 'team', 'performanceAgent', 'actionQueue',
...
export const TAB_LABELS = {
  ...
  tasks: 'Progetti & Task', timeTracking: 'Lyftimer', chat: 'LyftTalk', team: 'Squadra AI', performanceAgent: 'Performance Agent', actionQueue: 'Coda Azioni',
...
export const ROLE_TABS = {
  cro_specialist: ['dashboard', 'clienti', 'kpiBrain', 'attribution', 'ltvCohorts', 'cro', 'webScanner', 'seoAudit', 'competitorIntel', 'brandIdentity'],
  ecommerce_manager: ['dashboard', 'inventory', 'productPerformance', 'productCosts', 'clienti', 'kpiBrain', 'attribution', 'ltvCohorts', 'klaviyo', 'cro', 'webScanner', 'seoAudit', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'competitorIntel', 'creativeIntel', 'brandIdentity'],
  advertising_manager: ['creative', 'metaDetail', 'metaKpi', 'lighthouse', 'creativeFatigue', 'budgetAdvisor', 'metaLeadgen', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'seoAudit', 'webScanner', 'cro', 'clienti', 'klaviyo', 'performanceAgent', 'competitorIntel', 'creativeIntel', 'actionQueue', 'brandIdentity'],
  data_analyst: ['inventory', 'productPerformance', 'productCosts', 'clienti', 'kpiBrain', 'attribution', 'ltvCohorts', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'metaDetail', 'metaKpi', 'competitorIntel', 'creativeIntel'],
}
