...
export const ROLE_TABS = {
  ...
  advertising_manager: ['creative', 'metaDetail', 'metaKpi', 'lighthouse', 'creativeFatigue', 'budgetAdvisor', 'seoAudit', 'webScanner', 'cro', 'klaviyo', 'performanceAgent', 'creativeLab', 'creativeStudio', 'social', 'competitorIntel', 'priceComparison', 'actionQueue'],
...
export const ALWAYS_TABS = ['onboarding', 'tasks', 'timeTracking', 'chat']
