...
export const ROLE_TABS = {
  cro_specialist: ['dashboard', 'kpiBrain', 'attribution', 'ltvCohorts', 'cro', 'webScanner', 'seoAudit', 'competitorIntel', 'priceComparison', 'brandIdentity'],
  ecommerce_manager: ['dashboard', 'inventory', 'productPerformance', 'productCosts', 'kpiBrain', 'attribution', 'ltvCohorts', 'klaviyo', 'cro', 'webScanner', 'seoAudit', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'competitorIntel', 'priceComparison', 'creativeIntel', 'brandIdentity'],
  advertising_manager: ['creative', 'metaDetail', 'metaKpi', 'lighthouse', 'creativeFatigue', 'budgetAdvisor', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'seoAudit', 'webScanner', 'cro', 'klaviyo', 'performanceAgent', 'creativeStudio', 'competitorIntel', 'priceComparison', 'creativeIntel', 'actionQueue', 'brandIdentity'],
  data_analyst: ['inventory', 'productPerformance', 'productCosts', 'kpiBrain', 'attribution', 'ltvCohorts', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'metaDetail', 'metaKpi', 'competitorIntel', 'priceComparison', 'creativeIntel'],
}

// Tab sempre visibili a tutti i membri.
export const ALWAYS_TABS = ['onboarding', 'tasks', 'timeTracking', 'chat', 'team']
