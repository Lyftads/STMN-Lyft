...
export const ROLE_TABS = {
  ...
  ecommerce_manager: ['dashboard', 'inventory', 'kpiBrain', 'attribution', 'ltvCohorts', 'klaviyo', 'cro', 'webScanner', 'seoAudit', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator'],
  ...
  data_analyst: ['inventory', 'kpiBrain', 'attribution', 'ltvCohorts', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'competitorIntel', 'priceComparison', 'creativeIntel'],
}
