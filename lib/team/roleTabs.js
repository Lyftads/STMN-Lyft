...
export const ALL_TABS = [
  ...
  'tasks', 'calendar', 'timeOff', 'timeTracking', 'chat', 'creativeLibrary', 'team', 'performanceAgent',
  'cro', 'webScanner', 'seoAudit', 'creativeIntel',
  'creative', 'metaDetail', 'metaKpi', 'lighthouse', 'creativeFatigue', 'budgetAdvisor', 'metaLeadgen',
  'googleDetail', 'googleProducts', 'googleVerdicts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor',
...
export const TAB_LABELS = {
  ...
  tasks: 'Progetti & Task', calendar: 'Calendario', timeOff: 'Ferie e permessi', timeTracking: 'Lyftimer', chat: 'LyftTalk', creativeLibrary: 'Creatività', team: 'Squadra AI', performanceAgent: 'Performance Agent',
  cro: 'CRO', webScanner: 'AI Website Scanner', seoAudit: 'SEO Audit', creativeIntel: 'Creative Intel',
  creative: 'Creative', metaDetail: 'Meta Detail', metaKpi: 'Meta KPI', lighthouse: 'Meta Lighthouse', creativeFatigue: 'Creative Fatigue', budgetAdvisor: 'Meta Budget Advisor', metaLeadgen: 'Lead Gen',
  googleDetail: 'Google Detail', googleProducts: 'Google Prodotti', googleVerdicts: 'Verdetti prodotti', googleKpi: 'Google KPI', googleLighthouse: 'Google Lighthouse', googleBudgetAdvisor: 'Google Budget Advisor',
...
export const ROLE_TABS = {
  ...
  ecommerce_manager: ['dashboard', 'inventory', 'productPerformance', 'productCosts', 'clienti', 'kpiBrain', 'attribution', 'ltvCohorts', 'klaviyo', 'cro', 'webScanner', 'seoAudit', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'creativeIntel', 'brandIdentity'],
  advertising_manager: ['creative', 'metaDetail', 'metaKpi', 'lighthouse', 'creativeFatigue', 'budgetAdvisor', 'metaLeadgen', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'seoAudit', 'webScanner', 'cro', 'clienti', 'klaviyo', 'performanceAgent', 'creativeIntel', 'brandIdentity'],
  data_analyst: ['inventory', 'productPerformance', 'productCosts', 'clienti', 'kpiBrain', 'attribution', 'ltvCohorts', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'metaDetail', 'metaKpi', 'creativeIntel'],
}
