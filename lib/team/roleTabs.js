...
export const ALL_TABS = [
  ...
  'tasks', 'calendar', 'timeOff', 'timeTracking', 'chat', 'creativeLibrary', 'team', 'performanceAgent', 'actionQueue',
...
export const TAB_LABELS = {
  ...
  tasks: 'Progetti & Task', calendar: 'Calendario', timeOff: 'Ferie e permessi', timeTracking: 'Lyftimer', chat: 'LyftTalk', creativeLibrary: 'Creatività', team: 'Squadra AI', performanceAgent: 'Performance Agent', actionQueue: 'Coda Azioni',
...
export const ROLE_TABS = {
  ...
  advertising_manager: ['creative', 'metaDetail', 'metaKpi', 'lighthouse', 'creativeFatigue', 'budgetAdvisor', 'metaLeadgen', 'googleDetail', 'googleProducts', 'googleKpi', 'googleLighthouse', 'googleBudgetAdvisor', 'seoAudit', 'webScanner', 'cro', 'clienti', 'klaviyo', 'performanceAgent', 'creativeIntel', 'actionQueue', 'brandIdentity'],
