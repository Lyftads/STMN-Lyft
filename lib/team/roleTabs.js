...
export const ROLE_TABS = {
  ...
  ecommerce_manager: ['dashboard', 'kpiBrain', 'attribution', 'ltvCohorts', 'klaviyo', 'cro', 'webScanner', 'seoAudit', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator'],
  advertising_manager: ['creative', 'metaDetail', 'metaKpi', 'lighthouse', 'creativeFatigue', 'budgetAdvisor', 'seoAudit', 'webScanner', 'cro', 'klaviyo', 'performanceAgent', 'creativeStudio', 'social', 'competitorIntel', 'priceComparison', 'creativeIntel', 'actionQueue'],
  data_analyst: ['kpiBrain', 'attribution', 'ltvCohorts', 'pnl', 'scheduledReports', 'weekly', 'monthly', 'quarter', 'year', 'simulator', 'competitorIntel', 'priceComparison', 'creativeIntel'],
}
