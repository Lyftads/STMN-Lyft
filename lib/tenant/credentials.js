...
function emptyCreds() {
  return {
    ...
    meta: { accessToken: null, adAccountId: null, graphVersion: process.env.META_GRAPH_VERSION || 'v20.0' },
    google: { clientId: process.env.GOOGLE_CLIENT_ID || null, clientSecret: process.env.GOOGLE_CLIENT_SECRET || null, refreshToken: null, ga4PropertyId: null },
